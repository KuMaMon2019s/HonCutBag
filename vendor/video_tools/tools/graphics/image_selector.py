...
class ImageSelector(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "callback_url": {
                "type": "string",
                "description": "Provider-specific callback URL. Current video providers still poll by default.",
            },
            "external_task_id": {
                "type": "string",
    ...
    def _providers(self) -> list[BaseTool]:
        ...
        from vendor.video_tools.tools.tool_registry import registry
    ...
    def execute(self, inputs: dict[str, Any]) -> ToolResult:
        import logging
        from vendor.video_tools.lib.scoring import rank_providers
    ...
    def _prepare_task_context(self, inputs: dict[str, Any]) -> dict[str, Any]:
        from vendor.video_tools.lib.scoring import normalize_task_context
