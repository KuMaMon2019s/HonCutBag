...
def parse_shots(storyboard: dict) -> list:
    ...
    for s in storyboard["shots"]:
        shot = {
            ...
            "body_action_choreography": s.get("body_action_choreography", []),
            "body_action_contract": s.get("body_action_contract"),
            ...
            "source_time_values": s.get("source_time_values", []),
            "temporal_visual_contract": s.get("temporal_visual_contract"),
            "lighting_description": s.get("lighting_description", ""),
...
def setup_shot_dirs(shots: list) -> list:
    ...
    for shot in shots:
        ...
        meta = {
            ...
            "body_action_choreography": shot.get("body_action_choreography", []),
            "body_action_contract": shot.get("body_action_contract"),
            ...
            "time_window": shot.get("time_window", ""),
            "source_time_values": shot.get("source_time_values", []),
            "temporal_visual_contract": shot.get("temporal_visual_contract"),
            "lighting_description": shot.get("lighting_description", ""),
