"""Bridge HonCut playbooks → HyperFrames-friendly style artifacts.

HonCut playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by HonCut HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
