...
STORYBOARD_MOTION_POLICY = (
    ...
    "若文字动作合同给主体分配了肢体、姿态、接触或位移动作，主体必须成为主要运动来源："
    "躯干、四肢、关节、重心及相关道具必须按动作连续产生可见变化，不得把参考分镜首帧当作定格图。"
    "不得只让背景人群、车辆、光影、粒子、布料、头发或摄影机产生运动，而让动作主体保持原姿势；"
    "背景与运镜只能辅助，不能替代主体完成动作。只有文字合同明确要求静止、停止或定格时，主体才可保持静止。"
