...
USER_PROMPT_TEMPLATE = (
    ...
    "P01 以角色图+本格故事图等多图生成第一段；复杂镜头的 P02 截取 P01 视频末段后延长，P03 用 P02"
    "真实尾帧作首帧、下一 Sxx 的 P01 作尾帧生成交接。换场、跳时、主体切换、"
    ...
    "后续由编剧引擎按动作、人物交互、空间与运镜复杂度自动拆成 1–3 个内部 Pxx；拆分只能重排时长，"
...
BATCH_EXPAND_PROMPT = (
    ...
    "每个 Sxx 的 P01 用角色图+本格故事图等多图生成；复杂镜头的 P02 截取 P01 视频末段后延长，"
    "P03 用 P02 真实尾帧作首帧、下一 Sxx 的 P01 作尾帧生成交接。\n"
    ...
    "供后续编剧引擎按复杂度拆成 1–3 个 Pxx 顺序执行；Pxx 必须逐项覆盖当前 Sxx 的原始动作，"
