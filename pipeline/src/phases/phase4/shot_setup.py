    ...
    *,
    ...
    for index, source in enumerate(source_shots):
        ...
        shot = {
            ...
            "source_sequence_ids": source.get("source_sequence_ids", []),
            "source_action_unit_ids": source.get("source_action_unit_ids", []),
            "director_intent": source.get("director_intent"),
            ...
            "camera_angle": source.get("camera_angle"),
    ...
    for shot in shots:
        ...
        meta = {
            ...
            for key in (
                ...
                "source_sequence_ids", "source_action_unit_ids", "director_intent",
                "start_state", "end_state", "causal_link",
                "shot_type", "shot_size", "camera_angle", "camera_movement", "where", "time",
