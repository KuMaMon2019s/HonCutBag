...
from clients.kling.account import account_usage_hint_for_error, get_account_costs
from clients.kling.callbacks import validate_callback_url
from clients.kling.client import KlingClient
from clients.kling.errors import KlingAPIError
from clients.kling.media import extension_from_url, numbered_output_path, output_path_with_suffix
from clients.kling.schemas import TTS_LANGUAGES, TTS_SPEED_MAX, TTS_SPEED_MIN
...
class KlingTTS(BaseTool):
    ...
    install_instructions = (
        ...
        "Pass voice_id explicitly; HonCut does not guess Kling voice IDs."
    )
        ...
        result.update(
            {
                ...
                "cost_estimate_basis": "Conservative character-based HonCut estimate pending official account-usage reconciliation.",
            }
        )
        return result
