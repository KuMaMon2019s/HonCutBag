...
class VideoSelector(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "callback_url": {
                "type": "string",
                "description": "Provider-specific callback URL. Current HonCut providers still poll by default.",
            },
            "external_task_id": {
                "type": "string",
    ...
    def execute(self, inputs: dict[str, object]) -> ToolResult:
        from utils.scoring import rank_providers
    ...
    def _select_best_tool(
        ...
        """
        from utils.scoring import rank_providers, ProviderScore
    ...
    def _prepare_task_context(self, inputs: dict[str, object]) -> dict[str, object]:
        from utils.scoring import normalize_task_context
