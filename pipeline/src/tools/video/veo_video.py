...
from utils.google_credentials import GOOGLE_API_TIMEOUT_SECONDS
...
class VeoVideo(BaseTool):
    ...
    def _get_google_credentials_status(self) -> bool:
        ...
        from utils.google_credentials import has_google_credentials
    ...
    def _execute_google(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            import requests
            from utils.google_credentials import get_genai_client, GOOGLE_API_TIMEOUT_MS
