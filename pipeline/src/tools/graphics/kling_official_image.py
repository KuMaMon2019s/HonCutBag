...
from clients.kling.elements import element_ids, normalize_element_list
from clients.kling.errors import KlingAPIError
from clients.kling.media import (
    extension_from_url,
    normalize_image_input,
    numbered_output_path,
    output_path_with_suffix,
)
from clients.kling.omni import build_image_prompt_references
from clients.kling.schemas import (
    IMAGE_ASPECT_RATIOS,
        ...
        result.update(
            {
                ...
                "cost_estimate_basis": "Conservative HonCut estimate; official account usage reconciliation is planned for Phase 2.",
            }
        )
        return result
