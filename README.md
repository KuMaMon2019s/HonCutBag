...
| Phase 2 | Storyboard Images | Per-Pxx PREVIS plus one annotated 3×3 narrative grid per Sxx; persisted Gxx→Pxx guides enter Phase 6 as story-direction references, never as output pixels |
...
| Phase 6 | Video Generation | P01 submits cinematic image 1, character boards, and its Gxx narrative guide; P02+ submits predecessor video 1, character boards, its own guide, and tail anchors through the crash-safe runtime |
